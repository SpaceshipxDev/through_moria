...
def generate_quote_excel(processed_data, output_filename):
    """Generate beautifully formatted modern quote Excel file without yellow highlights"""
    ...
    # Fillable customer fields without yellow highlight
    customer_fields = [
    ...
    for idx, row_data in enumerate(processed_data):
        ...
        for col_num, value in enumerate(row_values, 1):
            ...
            elif col_num == 7:  # Unit price column (no yellow highlight)
                cell.value = value
        ...
        if row_data.get("image_file") and row_data["image